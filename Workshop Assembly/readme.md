...
### Step 6: Install the Audio Connector <br>
...
### Step 7: Install the SD Card connector board
...
### Step 8: The USB PC Serial Power Connector <br>
...
If power up test works, test the rest of the system such as the keyboard and the audio. The CHIP will make a tone when powering on.<br>
Continue on to the User Manual for more information.
